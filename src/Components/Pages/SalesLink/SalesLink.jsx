  ...
  return (
    <div className="bg-white py-20">
      <div className="flex justify-between max-w-[1400px] mx-auto ">
        <div
          className=" py-10 px-12 rounded-xl bg-[#BBEBBD] hover:shadow-lg cursor-pointer"
        ...
        <div
          data-aos="fade-up"
          className=" py-10 px-12 rounded-xl bg-[#F9F6BF] hover:shadow-lg cursor-pointer"
        >
          <img src={image2} alt="" />{' '}
          <div className="border border-orange-500 w-5 flex justify-center items-center mx-auto mt-7 mb-4"></div>
        ...
        <div
          data-aos="fade-down"
          className=" py-10 px-12 rounded-xl bg-[#FFF1D8] hover:shadow-lg cursor-pointer"
        >
          <img src={image3} alt="" />
          <div className="border border-orange-500 w-5 flex justify-center items-center mx-auto mt-7 mb-4"></div>
        ...
        <div
          data-aos="fade-up"
          className=" py-10 px-12 rounded-xl bg-[#fdd7ee] hover:shadow-lg cursor-pointer"
        >
          <img src={image4} alt="" />
          <div className="border border-orange-500 w-5 flex justify-center items-center mx-auto mt-7 mb-4"></div>
        ...
        <div
          data-aos="fade-down"
          className=" py-10 px-12 rounded-xl bg-[#fde2b7] hover:shadow-lg cursor-pointer"
        >
          <img src={image5} alt="" />
          <div className="border border-orange-500 w-5 flex justify-center items-center mx-auto mt-7 mb-4"></div>
        ...
        <div
          className=" py-10 px-12 rounded-xl bg-[#FFF0D8] hover:shadow-lg cursor-pointer"
